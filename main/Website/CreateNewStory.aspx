...
CodeFile="CreateNewStory.aspx.cs" Inherits="CreateNewStory" EnableViewState="false"%>
...
function cmdAddNewTitle()
{
    ...
    //var m = assembleMacro("AddNewStory");
    var m = new macro();
    m.name = "AddNewStory";
   ...
   addParam(m,"nLayoutToUse", layoutToUse );
   addParam(m,"chatEnabled", chatEnabled.value );
