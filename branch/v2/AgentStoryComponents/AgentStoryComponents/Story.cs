...
/// </summary>
        ...
        private void loadStoryFromDB(int storyID)
        {
            ...
            if (dbHelper.reader.HasRows)
            {
                ...
                this.ViewableBy = (string)dbHelper.reader["viewableBy"];
                this.EditableBy = (string)dbHelper.reader["editableBy"];
        ...
        public int Save()
        {
            ...
            if (this.ID == -1)
            {
                ...
                sql += "INSERT INTO Story ( title,user_id_originator,dateAdded,guid,viewableBy,editableBy,description,state,typeStory) VALUES ( ";
            ...
            else
            {
                ...
                {
                    sql += ",";
                    sql += " viewableBy = '" + this.ViewableBy + "'";
                }
                if (this.EditableBy != null)
                {
                    sql += ",";
                    sql += " editableBy = '" + this.EditableBy + "'";
                }
